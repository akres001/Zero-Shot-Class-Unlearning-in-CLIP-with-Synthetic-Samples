...
if [ "$MODELTYPE" = "RN" ]; then
    ...
    python3 gen_data.py --high_prob 0.85 --run_ds 'OxfordFlowers' --forget_labels 'tree mallow' --backbone_arch 'ViT-B/16'
    ...
    python3 gen_data.py --high_prob 0.99 --run_ds 'Caltech101' --forget_labels 'platypus' --backbone_arch 'ViT-B/16'
    python3 gen_data.py --high_prob 0.99 --run_ds 'Caltech101' --forget_labels 'minaret' --backbone_arch 'ViT-B/16'
